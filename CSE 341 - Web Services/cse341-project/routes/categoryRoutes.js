 ...
 *         description: Category not found
 */
router.put('/:id', isAuthenticated, validateObjectId, validateCategory, categoryController.updateCategory);
 ...
 *         description: Category not found
 */
router.delete('/:id', isAuthenticated, validateObjectId, categoryController.deleteCategory);
